...
export class Dijkstra extends MinIndexedPQ{
      ...
      for (const neighbor of this.matrix[row][col]) {
        ...
        if (newCost < this.travelCost[nRow][nCol]) {
          ...
          if (!this.contains(nRow * this.width + nCol)) {
            this.insert(nRow * this.width + nCol, newCost)

          } else {
            this.decreaseKey(nRow * this.width + nCol, newCost)
          }

          // Add value to set and yield updated scope
